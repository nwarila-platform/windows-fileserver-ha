  ...
  $script:Folders = @(
    ...
    @{
      ...
      access = @(
        ...
        $script:Protected[1]
        @{
          principal = 'TCN\TCN_GS-FileShare_Sites-North-Projects-Modify'
          access_control_type = 'Allow'
          rights = 'Modify'
        }
        @{
          principal = 'TCN\TCN_GS-FileShare_Sites-North-Projects-Read'
          access_control_type = 'Allow'
...
Describe 'Set-ClusteredFolderTree' {
  BeforeEach {
    $global:FsFolderSid = @{
      ...
      'TCN\TCN_GS-FileShare_Sites-North-Modify' = 'S-1-5-21-1000-1101'
      'TCN\TCN_GS-FileShare_Sites-North-Projects-Modify' = 'S-1-5-21-1000-1102'
      'TCN\TCN_GS-FileShare_Sites-North-Projects-Read' = 'S-1-5-21-1000-1103'
      'TCN\TCN_GS-FileShare_Sites-North-Read' = 'S-1-5-21-1000-1104'
      'Everyone' = 'S-1-1-0'
    }
    ...
    $global:FsFolderAcls = @{
      'D:\shares\sites\North' = New-FakeAcl -Protected $True -Access @(
        ...
        $(New-FakeRule -Principal 'TCN\TCN_GS-FileShare_Sites-North-Modify' -Rights 'Modify')
      )
      'D:\shares\sites\North\Projects' = New-FakeAcl -Protected $False -Access @(
        $(New-FakeRule -Principal 'NT AUTHORITY\SYSTEM' -Rights 'FullControl')
        $(New-FakeRule -Principal 'BUILTIN\Administrators' -Rights 'FullControl')
        $(New-FakeRule -Principal 'TCN\TCN_GS-FileShare_Sites-North-Projects-Modify' -Rights 'Modify')
        $(New-FakeRule -Principal 'TCN\TCN_GS-FileShare_Sites-North-Projects-Read' -Rights 'ReadAndExecute')
        $(New-FakeRule -Principal 'TCN\TCN_GS-FileShare_Sites-North-Modify' -Rights 'Modify' -Inherited $True)
      )
  ...
  It 'accepts ReadAndExecute NTFS rights for a read-only folder grant' {
    ...
    $ReadOnlyFolders[0].access[2].principal = 'TCN\TCN_GS-FileShare_Sites-North-Read'
    $ReadOnlyFolders[0].access[2].rights = 'ReadAndExecute'
    $global:FsFolderAcls['D:\shares\sites\North'].Access[2] = New-FakeRule `
      -Principal 'TCN\TCN_GS-FileShare_Sites-North-Read' -Rights 'ReadAndExecute'
